...
const routes = [{ path: '', component: _yanglao_component__WEBPACK_IMPORTED_MODULE_3__["YanglaoComponent"] }];
let YanglaoRoutingModule = class YanglaoRoutingModule {
};
...
let YanglaoComponent = class YanglaoComponent {
    constructor() {
        this.searchValue = '';
        this.sortName = null;
        this.sortValue = null;
    ...
    search() {
        ...
        const filterFunc = item => {
            return ((this.listOfSearchAddress.length
                ? this.listOfSearchAddress.some(address => item.街道乡镇.indexOf(address) !== -1)
...
let YanglaoModule = class YanglaoModule {
};
