...
const routes = [{ path: '', component: _yibao_component__WEBPACK_IMPORTED_MODULE_3__["YibaoComponent"] }];
let YibaoRoutingModule = class YibaoRoutingModule {
};
...
let YibaoComponent = class YibaoComponent {
    constructor() {
        this.searchValue = '';
        this.sortName = null;
        this.sortValue = null;
...
let YibaoModule = class YibaoModule {
};
